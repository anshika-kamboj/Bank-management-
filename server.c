...
//creating socket file Descripter
	...
	portNO = atoi(argv[1]);//PORT NUMBER WHERE CLIENT IS
...
// Listening 
  ...
  //for multiple clients therefore while(1)
	while(1) 
	{
		//blocking call
		memset(&cli_addr, 0, sizeof(cli_addr));
//accept from client in client file descripter clientFD		
